        ...
        <div class="row">
            ...
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Create Alumnies</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <form role="form" method="post" action="{{route('alumnies.store')}}" id="createAlumni" data-toggle="validator">
                        {!! csrf_field() !!}
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="middleName" placeholder="Middle Name" id="middleName" required/>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="enrollmentYear" id="enrollmentyear" required>
