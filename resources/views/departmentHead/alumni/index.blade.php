...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <li class="active"><a href="{{ route('departmentAlumnies.index') }}">Alumnies</a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="row" style="padding-bottom:10px;">
            <div class="col-xs-12">
                <form class="form-inline" role="form" method="POST" action="{{ route('departmentAdvancedReports') }}" data-toggle="validator">
                    {!! csrf_field() !!}
                                ...
                                @if(count($alumnies) > 0)
                                    ...
                                    @foreach ($alumnies as $alumni)
                                        <tr>
                                            ...
                                            <td>{{ $alumni->year_of_enrollment }}</td>
                                            <td>{{ $alumni->year_of_graduation }}</td>
                                            <td width=10%>
                                                <a href="{!! route('departmentAlumnies.show',$alumni->id) !!}" class="" id ="">View <span class="fa fa-link"></span></a>
                                            </td>
                                        </tr>
